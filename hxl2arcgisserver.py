...
def main():
	...
	p.add_option('--server', '-s', dest='server', default='127.0.0.1', help='ArcGIS server instance with WFS-T enabled')
	p.add_option('--port', '-p', dest='port', type='int', default=80)
	p.add_option('--user', '-u', dest='username', default='')
...
#		sys.exit(1)
	...
	server = hxl.arcgisserver.ArcGISServer(o.server, o.port, '/geoserver', o.username, password, o.dbname)
